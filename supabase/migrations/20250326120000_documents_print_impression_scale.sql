-- documents.print_impression_scale + RPC publish_tae_transaction / update_tae_transaction
-- Aligné sur supabase/schema.sql (2025-03-26).

ALTER TABLE documents
  ADD COLUMN IF NOT EXISTS print_impression_scale numeric(3,2) NOT NULL DEFAULT 1.00;
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE t.relname = 'documents'
      AND c.conname = 'documents_print_impression_scale_check'
  ) THEN
    ALTER TABLE documents ADD CONSTRAINT documents_print_impression_scale_check
