-- RPC TAÉ : alignement sur supabase/schema.sql pour persister tae.non_redaction_data (OI 1.3).
-- Prérequis : migration 20260330220000_tae_non_redaction_data.sql (colonne JSONB).
-- Source de vérité : garder ce fichier aligné avec les mêmes fonctions dans schema.sql.
