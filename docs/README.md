...
| [FRAGMENT-PLAYGROUND.md](./FRAGMENT-PLAYGROUND.md)                       | **DEV** — Fragment Playground (`/dev/fragments`) : comportement × contexte, mocks `TaeFicheData`, règles d’import                                                                                                                                                                                 |
| [CONVENTIONS-FRAGMENTS.md](./CONVENTIONS-FRAGMENTS.md)                   | **Norme** — Nomenclature fragments (`Fragment` / `App` / `Print`), rédactionnel / NR, documents, fiche seule vs imprimable                                                                                                                                                                        |
...
| [TUTORIEL-IMPORT-TAE-NOTEBOOKLM.md](./TUTORIEL-IMPORT-TAE-NOTEBOOKLM.md) | **Enseignant / contributeur** — importer une TAÉ **sans wizard** : rôle du bundle `import-tae-notebooklm-bundle.json`, sources pédagogiques, PDA verbatim, NotebookLM ; lien `lib/tae/import/` et backlog parcours app                                                                            |
...
| `app/dev/fragments/`       | **DEV** — Fragment Playground (mocks, pas de Supabase) ; 404 en production — [ARCHITECTURE.md](./ARCHITECTURE.md#routes-app-router) ; [CONVENTIONS-FRAGMENTS.md](./CONVENTIONS-FRAGMENTS.md) |
| `app/dev/summary-mockup/`  | **DEV** — maquettes banque : miniature liste + fiche sommaire (`TaeFicheData` mocks) ; 404 en production — [ARCHITECTURE.md](./ARCHITECTURE.md#routes-app-router)                            |
