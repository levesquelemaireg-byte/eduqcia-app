...
| [TUTORIEL-IMPORT-TAE-NOTEBOOKLM.md](./TUTORIEL-IMPORT-TAE-NOTEBOOKLM.md) | **Enseignant / contributeur** — importer une TAÉ **sans wizard** : rôle du bundle `import-tae-notebooklm-bundle.json`, sources pédagogiques, PDA verbatim, NotebookLM ; lien `lib/tache/import/` et backlog parcours app                                                                           |
