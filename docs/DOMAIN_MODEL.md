...
| Tâche d'apprentissage et d'évaluation                     | **Tâche** (ou forme longue **TAÉ** quand le contexte éditorial l'exige)     | `DonneesTache` / `Tache` (**jamais `Task`**)                                                                    | `tache` (depuis Phase 0, 22 avril 2026 — renommé depuis `tae`) | `lib/tache/contrats/donnees.ts`                        |
