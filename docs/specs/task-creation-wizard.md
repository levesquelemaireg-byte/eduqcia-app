...
Dernier audit connu : `docs/audits/audit-2026-04-08-task-creation-wizard.md` — plusieurs écarts identifiés (12 régressions, 3 innovations à faire remonter, 6 ambiguïtés à clarifier, 5 absences franches), en cours de traitement via `docs/todos/post-audit-corrections.md`.
