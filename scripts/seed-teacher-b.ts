/**
 * Compte enseignant « B » pour tests locaux (RLS, deux sessions).
 * Crée auth.users + public.profiles (service role). Mot de passe : 12345678.
 *
 * Usage : npm run seed:teacher-b
 */
...
async function main(): Promise<void> {
  ...
  console.log("public.profiles : profil enseignant upsert OK");
  console.log("");
  console.log("Compte B (connexion locale) :");
