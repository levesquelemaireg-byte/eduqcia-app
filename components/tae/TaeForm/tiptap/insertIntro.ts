...
export function buildIntroInlineContent(nbDocs: number): JSONContent[] {
...
/** CONSIGNE-EDITOR.md §6 — insert full intro + paragraph vide pour le curseur. */
export function insertIntroPhrase(editor: Editor, nbDocs: number) {
