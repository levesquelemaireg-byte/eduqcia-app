...
import { GenericEchelleGrid } from "@/components/tae/grilles/GenericEchelleGrid";
import { GrilleOI3SO5 } from "@/components/tae/grilles/GrilleOI3SO5";
import { GrilleOI6SO3 } from "@/components/tae/grilles/GrilleOI6SO3";
import { GrilleOI7SO1 } from "@/components/tae/grilles/GrilleOI7SO1";

/** Identifiants avec composant dédié (structure hors `bareme.echelle`). */
export const DEDICATED_GRILLES = ["OI3_SO5", "OI6_SO3", "OI7_SO1"] as const;
