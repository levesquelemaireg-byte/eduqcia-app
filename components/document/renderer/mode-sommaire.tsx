...
/**
 * Rendu d'un document historique dans un panneau sommaire (fiche tâche, vue détaillée).
 *
 * Gère les trois structures (simple, perspectives, deux_temps) avec un
 * branchement interne. Réutilise les styles de `printable-fiche-preview.module.css`
 * pour l'alignement pixel-perfect avec le rendu print.
 */
export function ModeSommaire({ document: doc, numero }: Props) {
