...
export type TachePrintFeuilletId = "dossier" | "questionnaire";

type Props = {
  active: TachePrintFeuilletId;
  onChange: (id: TachePrintFeuilletId) => void;
  className?: string;
};
 ...
 */
export function TachePrintFeuilletToggle({ active, onChange, className }: Props) {
  return (
    <div
      role="tablist"
