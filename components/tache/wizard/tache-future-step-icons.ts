 ...
 */
export const BLOC5_TACHE_STEPPER_ICONS = ["task_alt", "list_alt_check"] as const;
export const BLOC6_CD_TACHE_STEPPER_ICONS = ["license"] as const;
export const BLOC7_TACHE_STEPPER_ICONS = ["deployed_code", "lightbulb"] as const;
