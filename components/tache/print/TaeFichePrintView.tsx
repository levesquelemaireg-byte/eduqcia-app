...
import { PrintableFicheFromTaeData } from "@/components/tache/wizard/preview/PrintableFichePreview";
 ...
 */
export function TaeFichePrintView({ taeId, tae }: Props) {
  const handlePrint = () => {
    window.print();
  };
  ...
  return (
    <div className="flex min-h-full flex-col">
      <div className="tae-print-screen-only border-b border-border bg-panel px-4 py-3 shadow-sm sm:px-6">
