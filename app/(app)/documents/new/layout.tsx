...
/**
 * Même enveloppe que `questions/new` — split wizard pleine largeur, compensation du padding
 * `main.main--app` (`p-4` / `md:p-6`) — voir `AppShellClient`, `docs/WORKFLOWS.md` § Wizard document.
 */
