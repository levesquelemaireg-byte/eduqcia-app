...
import { buildPublishPayload } from "@/lib/tache/publish-tae-payload";
import {
  getDisciplineId,
  getNiveauId,
  resolveCdId,
  resolveConnaissanceIds,
} from "@/lib/tache/publish-tae-lookups";
import { classifyPublishRpcError } from "@/lib/tache/publish-tae-rpc-errors";
import type { PublishTaeResult, TaeVersionSnapshot } from "@/lib/tache/publish-tae-types";
...
import { detectVersionTrigger } from "@/lib/tache/publish-tae-version";
...
export type {
  ...
  TaeVersionSnapshot,
} from "@/lib/tache/publish-tae-types";
export { detectVersionTrigger } from "@/lib/tache/publish-tae-version";
