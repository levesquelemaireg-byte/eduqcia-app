...
import type { TacheVersionSnapshot, PublishTacheRpcPayload } from "@/lib/tache/publish-tache-types";
...
/**
 * Détection d'une modification majeure à partir du `TacheFormState` courant (frontend, pré-soumission).
