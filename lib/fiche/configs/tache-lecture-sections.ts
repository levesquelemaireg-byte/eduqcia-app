/**
 * Config FicheRenderer pour le mode lecture (TacheFicheData — données publiées/serveur).
 * Réutilise les mêmes composants section que le wizard, mais avec des selectors
 * qui lisent TacheFicheData (flat) au lieu de TacheFormState (blocs wizard).
 */
...
/**
 * Sections pour les modes lecture et thumbnail — typé TacheFicheData.
 *
...
export const TACHE_LECTURE_SECTIONS = [
  defineSection<TacheFicheData, HeaderData>({
    id: "header",
    stepId: null,
    selector: selectLectureHeader,
    component: FicheHeader,
  }),
  defineSection<TacheFicheData, ConsigneData>({
    id: "consigne",
    stepId: "consigne",
    selector: selectLectureConsigne,
    component: SectionConsigne,
  }),
  defineSection<TacheFicheData, GuidageData>({
    id: "guidage",
    stepId: "consigne",
  ...
  defineSection<TacheFicheData, DocumentsData>({
    id: "documents",
    stepId: "documents",
  ...
  defineSection<TacheFicheData, CorrigeData>({
    id: "corrige",
    stepId: "corrige",
  ...
  defineSection<TacheFicheData, GrilleData>({
    id: "grille",
    stepId: "parametres",
  ...
  defineSection<TacheFicheData, CompetenceData>({
    id: "cd",
    stepId: "cd",
  ...
  defineSection<TacheFicheData, ConnaissancesData>({
    id: "connaissances",
  ...
  defineSection<TacheFicheData, FooterData>({
    id: "footer",
    stepId: null,
